...
import (
	...
	controller "github.com/PacktPublishing/Kubernetes-Interview-Guide/chapter-11/books-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(packtv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "638d8b3a.packt.com",
